        ...
        <div className="w-full">
          <div>
            ...
            <div className="relative">
              <input
                className="peer block w-full rounded-md border border-gray-200 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-900 text-gray-900"
                id="email"
                type="email"
                name="email"
                ...
                required
              />
              <AtSymbolIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900 text-gray-900" />
            </div>
          </div>
          <div className="mt-4">
            <label
